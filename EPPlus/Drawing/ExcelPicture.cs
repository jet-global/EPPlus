...
namespace OfficeOpenXml.Drawing
{
	...
	public sealed class ExcelPicture : ExcelDrawing
	{
		...
		#region Properties
		/// <summary>
		/// Gets or sets the embedded <see cref="System.Drawing.Image"/> this <see cref="ExcelPicture"/> is displaying.
		/// </summary>
		public Image Image
		{
			get
		...
		/// <summary>
		/// Gets the <see cref="ExcelDrawingBorder"/> status for this drawing.
		/// </summary>
		...
		/// <summary>
		/// Gets the hyperlink clicking this picture would take you to.
		/// </summary>
			 ...
			 base(drawings, node, "xdr:pic/xdr:nvPicPr/xdr:cNvPr/@name")
		{
			...
			if (picNode != null)
			{
				var embed = picNode.Attributes["r:embed"]?.Value;
				if (embed != null)
				{
					RelPic = drawings.Part.GetRelationship(embed);
				...
				var link = picNode.Attributes["r:link"]?.Value;
				if (link != null)
				{
					RelPic = drawings.Part.GetRelationship(link);
					// This relationship defines a path to an image file in the file system, and is currently unsupported.
				}
