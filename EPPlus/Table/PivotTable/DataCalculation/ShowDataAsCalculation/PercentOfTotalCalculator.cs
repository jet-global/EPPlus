...
{
	/// <summary>
	/// Calculates the <see cref="ShowDataAs.PercentOfTotal"/> value in a pivot table.
	/// </summary>
	internal class PercentOfTotalCalculator : ShowDataAsCalculatorBase
	{
		...
		public PercentOfTotalCalculator(ExcelPivotTable pivotTable, int dataFieldCollectionIndex) : base(pivotTable, dataFieldCollectionIndex) { }
		#endregion
			...
			List<PivotCellBackingData> columnGrandTotalsValuesLists)
		{
			...
			{
				double denominator = (double)grandGrandTotalValues[base.DataFieldCollectionIndex].Result;
