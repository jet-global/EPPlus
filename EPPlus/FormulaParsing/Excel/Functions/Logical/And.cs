...
{
	/// <summary>
	/// Represents the Excel logical AND function.
	/// </summary>
	public class And : ExcelFunction
	{
		#region ExcelFunction Overrides
		/// <summary>
		/// Calculates the logical AND value of the specified arguments.
		/// </summary>
		/// <param name="arguments">The arguments on which to perform a logical AND.</param>
		/// <param name="context">The context in which to evaluate the function.</param>
		/// <returns>The result of the logical AND of the specified <paramref name="arguments"/>.</returns>
