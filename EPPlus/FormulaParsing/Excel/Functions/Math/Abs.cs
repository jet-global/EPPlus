...
{
	/// <summary>
	/// This class contains the formula for the Abs Excel Function.
	/// </summary>
	public class Abs : ExcelFunction
	{
		/// <summary>
		/// Takes a user specified argument and calculates its absolute value.
		/// </summary>
		...
		/// <returns>The absolute value of the argument given.</returns>
		public override CompileResult Execute(IEnumerable<FunctionArgument> arguments, ParsingContext context)
		{
			...
			if (numberValue < 0)
				numberValue *= -1;
			return this.CreateResult(numberValue, DataType.Decimal);
		}
	}
}
