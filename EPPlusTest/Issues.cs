	...
	public class Issues
	{
		...
		public void PreserveNamesAddressesWhenInsertingRows()
		{
			using (var package = new ExcelPackage())
			{
				...
				package.Workbook.Names.Add("myName1", new ExcelRange(sheet2, "$A$1"));
				package.Workbook.Names.Add("myName2", new ExcelRange(sheet2, "$A$2"));
				package.Workbook.Names.Add("myName3", new ExcelRange(sheet2, "$A$3"));
