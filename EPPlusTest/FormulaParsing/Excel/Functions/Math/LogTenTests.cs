...
{
	[TestClass]
	public class LogTenTests: MathFunctionsTestBase
	{
		...
		[TestMethod]
		public void Log10WithDoublesReturnsCorrectValue()
		{
			var function = new Log10();
		...
		[TestMethod]
		public void Log10WithDateFunctionInputReturnsCorrectValue()
		{
			using (var package = new ExcelPackage())
			{
				var ws = package.Workbook.Worksheets.Add("Sheet1");
				...
				ws.Calculate();
				Assert.AreEqual(4.632366172d, (double)ws.Cells["B1"].Value, 0.0001);
			}
		}
		...
		[TestMethod]
		public void Log10WithNumericStringReturnsCorrectValue()
		{
			var function = new Log10();
			var result = function.Execute(FunctionsHelper.CreateArgs("100"), this.ParsingContext);
			Assert.AreEqual(2d, result.Result);
		...
		[TestMethod]
		public void Log10WithGeneralStringsReturnsPoundValue()
		{
			var function = new Log10();
		...
		[TestMethod]
		public void Log10WiithNoArgumentsReturnsPoundValue()
		{
			var function = new Log10();
