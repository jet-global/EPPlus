...
namespace EPPlusTest.FormulaParsing.Excel.Functions.Math
{
	...
	[TestClass]
	public class StdevaTests : MathFunctionsTestBase
	{
		#region Stdeva Function(Execute) Tests
		...
		[TestMethod]
		public void StdevaIsGivenNumberInputFromCellRefrenceWithEmptyCellsFirst()
		{
			var function = new Stdeva();
			...
			using (var package = new ExcelPackage())
			{
				...
				worksheet.Cells["A12"].Formula = "=Stdeva(B1:B12)";
				worksheet.Calculate();
		...
		[TestMethod]
		public void StdevaIsGivenNumberInputFromCellRefrenceWithEmptyCellsFirstAndAnInvalidCellInTheMiddle()
		{
			var function = new Stdeva();
			...
			using (var package = new ExcelPackage())
			{
				...
				worksheet.Cells["A12"].Formula = "=Stdeva(B1:B11)";
				worksheet.Calculate();
		...
		[TestMethod]
		public void StdevaIsGivenNumbersAsInputs()
		{
			var function = new Stdeva();
		...
		[TestMethod]
		public void StdevaIsTheSameTestsAsGivenAMixOfInputTypesByCellRefrenceExceptTheyAreAllOnes()
		{
			var function = new Stdeva();
			using (var package = new ExcelPackage())
			{
				...
				worksheet.Cells["B6"].Formula = "=Stdeva(B1,B2,B4,B5)";
				worksheet.Cells["B8"].Formula = "=Stdeva(B1,B2)";
				worksheet.Cells["B9"].Formula = "=Stdeva(B1:B5)";
				worksheet.Calculate();
		...
		[TestMethod]
		public void StdevaIsGivenTwoRangesOfIntsAsInputsWithATimeInTheMiddleOfTheFirstRange()
		{
			var function = new Stdeva();
			using (var package = new ExcelPackage())
			{
				...
				worksheet.Cells["A9"].Formula = "=Stdeva(B1:B6, B7:B11)";
				worksheet.Calculate();
				Assert.AreEqual(24.85485136, (double)worksheet.Cells["A9"].Value, .00001);
			}
		}
		...
		[TestMethod]
		public void StdevaIsGivenAStringInputWithAEmptyCellInTheMiddleByCellRefrence()
		{
			var function = new Stdeva();
			using (var package = new ExcelPackage())
			{
				...
				worksheet.Cells["A12"].Formula = "=Stdeva(B3:B12)";
				worksheet.Calculate();
				Assert.AreEqual(26.97581221, (double)worksheet.Cells["A12"].Value, .00001);
			}
		}
		...
		[TestMethod]
		public void StdevaIsGivenMilitaryTimesAsInputs()
		{
			var function = new Stdeva();
		...
		[TestMethod]
		public void StdevaIsGivenMilitaryTimesAsInputsByCellRefrence()
		{
			var function = new Stdeva();
			using (var package = new ExcelPackage())
			{
		...
		[TestMethod]
		public void StdevaIsGiven12HourTimesAsInputsByCellRange()
		{
			var function = new Stdeva();
			using (var package = new ExcelPackage())
			{
		...
		[TestMethod]
		public void StdevaIsGivenMonthDayYear12HourTimeAsInputsByCellRefrence()
		{
			var function = new Stdeva();
			using (var package = new ExcelPackage())
			{
		...
		[TestMethod]
		public void StdevaIsGivenDateTimeInputsSeperatedByADashAsInputsByCellRefrence()
		{
			var function = new Stdeva();
			using (var package = new ExcelPackage())
			{
		...
		[TestMethod]
		public void StdevaIsGivenStringsAsInputs()
		{
			var function = new Stdeva();
		...
		[TestMethod]
		public void StdevaIsGivenStringsAsInputsByCellRefrence()
		{
			var function = new Stdeva();
			using (var package = new ExcelPackage())
			{
		...
		[TestMethod]
		public void StdevaIsGivenStringNumbersAsInputsByCellRefrence()
		{
			var function = new Stdeva();
			using (var package = new ExcelPackage())
			{
				...
				worksheet.Cells["A4"].Formula = "=Stdeva(A1,A2,A3)";
				worksheet.Cells["B4"].Formula = "=Stdeva(B1,B2,B3)";
				worksheet.Calculate();
		...
		[TestMethod]
		public void StdevAIsGivenASingleTrueBooleanInput()
		{
			var function = new Stdeva();
