		...
		public void PivotTableRefreshDataFieldShowDataAsPercentOfParentRowTotalColumnDataFields()
		{
			...
			using (var newFile = new TempTestFile())
			{
				...
				using (var package = new ExcelPackage(file))
				{
					...
					var cacheDefinition = package.Workbook.PivotCacheDefinitions.Single();
					cacheDefinition.UpdateData();
					ExcelPivotTableTest.CheckPivotTableAddress(new ExcelAddress("A40:N52"), pivotTable.Address);
					Assert.AreEqual(16, pivotTable.Fields.Count);
					package.SaveAs(newFile.File);
				}
				TestHelperUtility.ValidateWorksheet(newFile.File, sheetName, new[]
				{
					...
					new ExpectedCellValue(sheetName, 42, 1, "Quarters"),
					new ExpectedCellValue(sheetName, 43, 1, "Qtr1"),
					new ExpectedCellValue(sheetName, 44, 1, null),
					new ExpectedCellValue(sheetName, 45, 1, "Qtr2"),
					new ExpectedCellValue(sheetName, 46, 1, null),
					new ExpectedCellValue(sheetName, 47, 1, "Qtr3"),
					new ExpectedCellValue(sheetName, 48, 1, null),
					new ExpectedCellValue(sheetName, 49, 1, "Qtr4"),
					...
					new ExpectedCellValue(sheetName, 42, 2, "Debit/Credit"),
					new ExpectedCellValue(sheetName, 43, 2, "Both"),
					new ExpectedCellValue(sheetName, 44, 2, "Debit"),
					new ExpectedCellValue(sheetName, 45, 2, "Both"),
					new ExpectedCellValue(sheetName, 46, 2, "Debit"),
					new ExpectedCellValue(sheetName, 47, 2, "Both"),
					new ExpectedCellValue(sheetName, 48, 2, "Credit"),
					new ExpectedCellValue(sheetName, 49, 2, "Both"),
					new ExpectedCellValue(sheetName, 50, 2, "Credit"),
					new ExpectedCellValue(sheetName, 51, 2, "Debit"),
					new ExpectedCellValue(sheetName, 52, 2, null),
					new ExpectedCellValue(sheetName, 40, 3, "Values"),
					new ExpectedCellValue(sheetName, 41, 3, "Count of Net Change"),
					new ExpectedCellValue(sheetName, 42, 3, "Begin-Total"),
					new ExpectedCellValue(sheetName, 43, 3, 0.5),
					new ExpectedCellValue(sheetName, 44, 3, 0.5),
					new ExpectedCellValue(sheetName, 45, 3, 0),
					new ExpectedCellValue(sheetName, 46, 3, 1d),
					new ExpectedCellValue(sheetName, 47, 3, 0.5),
					new ExpectedCellValue(sheetName, 48, 3, 0.5),
					new ExpectedCellValue(sheetName, 49, 3, 0),
					new ExpectedCellValue(sheetName, 50, 3, 1d),
					new ExpectedCellValue(sheetName, 51, 3, 0),
					new ExpectedCellValue(sheetName, 52, 3, 1d),
					new ExpectedCellValue(sheetName, 40, 4, "Account Type"),
					new ExpectedCellValue(sheetName, 41, 4, null),
					new ExpectedCellValue(sheetName, 42, 4, "End-Total"),
					new ExpectedCellValue(sheetName, 43, 4, 1d),
					new ExpectedCellValue(sheetName, 44, 4, 0),
					new ExpectedCellValue(sheetName, 45, 4, 0.5),
					new ExpectedCellValue(sheetName, 46, 4, 0.5),
					new ExpectedCellValue(sheetName, 47, 4, 1d),
					new ExpectedCellValue(sheetName, 48, 4, 0),
					new ExpectedCellValue(sheetName, 49, 4, 0.5),
					new ExpectedCellValue(sheetName, 50, 4, 0.5),
					new ExpectedCellValue(sheetName, 51, 4, 0),
					new ExpectedCellValue(sheetName, 52, 4, 1d),
					new ExpectedCellValue(sheetName, 40, 5, null),
					new ExpectedCellValue(sheetName, 41, 5, null),
					new ExpectedCellValue(sheetName, 42, 5, "Posting"),
					new ExpectedCellValue(sheetName, 43, 5, 0),
					new ExpectedCellValue(sheetName, 44, 5, 1d),
					new ExpectedCellValue(sheetName, 45, 5, 0),
					new ExpectedCellValue(sheetName, 46, 5, 1d),
					new ExpectedCellValue(sheetName, 47, 5, 1d),
					new ExpectedCellValue(sheetName, 48, 5, 0),
					new ExpectedCellValue(sheetName, 49, 5, 0.4286),
					new ExpectedCellValue(sheetName, 50, 5, 0.1429),
					new ExpectedCellValue(sheetName, 51, 5, 0.4286),
					new ExpectedCellValue(sheetName, 52, 5, 1d),
					new ExpectedCellValue(sheetName, 40, 6, null),
					new ExpectedCellValue(sheetName, 41, 6, "Product of Balance at End Date"),
					new ExpectedCellValue(sheetName, 42, 6, "Begin-Total"),
					...
					new ExpectedCellValue(sheetName, 40, 7, null),
					new ExpectedCellValue(sheetName, 41, 7, null),
					new ExpectedCellValue(sheetName, 42, 7, "End-Total"),
					new ExpectedCellValue(sheetName, 43, 7, null),
					new ExpectedCellValue(sheetName, 44, 7, null),
					new ExpectedCellValue(sheetName, 45, 7, 0),
					new ExpectedCellValue(sheetName, 46, 7, 0),
					new ExpectedCellValue(sheetName, 47, 7, 1d),
					new ExpectedCellValue(sheetName, 48, 7, 0),
					new ExpectedCellValue(sheetName, 49, 7, 0),
					new ExpectedCellValue(sheetName, 50, 7, 0),
					new ExpectedCellValue(sheetName, 51, 7, 0),
					new ExpectedCellValue(sheetName, 52, 7, null),
					new ExpectedCellValue(sheetName, 40, 8, null),
					new ExpectedCellValue(sheetName, 41, 8, null),
					new ExpectedCellValue(sheetName, 42, 8, "Posting"),
					new ExpectedCellValue(sheetName, 43, 8, 0),
					new ExpectedCellValue(sheetName, 44, 8, 1d),
					new ExpectedCellValue(sheetName, 45, 8, 0),
					new ExpectedCellValue(sheetName, 46, 8, 1d),
					...
					new ExpectedCellValue(sheetName, 40, 9, null),
					new ExpectedCellValue(sheetName, 41, 9, "Sum of Net Change (Prior Year)"),
					new ExpectedCellValue(sheetName, 42, 9, "Begin-Total"),
					...
					new ExpectedCellValue(sheetName, 41, 10, null),
					new ExpectedCellValue(sheetName, 42, 10, "End-Total"),
					new ExpectedCellValue(sheetName, 43, 10, null),
					new ExpectedCellValue(sheetName, 44, 10, null),
					new ExpectedCellValue(sheetName, 45, 10, 4.4862),
					new ExpectedCellValue(sheetName, 46, 10, -3.4862),
					new ExpectedCellValue(sheetName, 47, 10, 1d),
					new ExpectedCellValue(sheetName, 48, 10, 0),
					new ExpectedCellValue(sheetName, 49, 10, 1.0998),
					new ExpectedCellValue(sheetName, 50, 10, -0.0998),
					new ExpectedCellValue(sheetName, 51, 10, 0),
					...
					new ExpectedCellValue(sheetName, 42, 11, "Posting"),
					new ExpectedCellValue(sheetName, 43, 11, 0),
					new ExpectedCellValue(sheetName, 44, 11, 1d),
					new ExpectedCellValue(sheetName, 45, 11, 0),
					new ExpectedCellValue(sheetName, 46, 11, 1d),
					new ExpectedCellValue(sheetName, 47, 11, null),
					new ExpectedCellValue(sheetName, 48, 11, null),
					new ExpectedCellValue(sheetName, 49, 11, -2.7852),
					new ExpectedCellValue(sheetName, 50, 11, 0),
					new ExpectedCellValue(sheetName, 51, 11, 3.7852),
					new ExpectedCellValue(sheetName, 52, 11, 1d),
					new ExpectedCellValue(sheetName, 40, 12, null),
					new ExpectedCellValue(sheetName, 41, 12, "Total Count of Net Change"),
					new ExpectedCellValue(sheetName, 42, 12, null),
					new ExpectedCellValue(sheetName, 43, 12, 0.6),
					new ExpectedCellValue(sheetName, 44, 12, 0.4),
					new ExpectedCellValue(sheetName, 45, 12, 0.25),
					new ExpectedCellValue(sheetName, 46, 12, 0.75),
					new ExpectedCellValue(sheetName, 47, 12, 1d),
					new ExpectedCellValue(sheetName, 48, 12, 0.25),
					new ExpectedCellValue(sheetName, 49, 12, 0.4),
					new ExpectedCellValue(sheetName, 50, 12, 0.3),
					new ExpectedCellValue(sheetName, 51, 12, 0.3),
					new ExpectedCellValue(sheetName, 52, 12, 1d),
					new ExpectedCellValue(sheetName, 40, 13, null),
					new ExpectedCellValue(sheetName, 41, 13, "Total Product of Balance at End Date"),
					...
					new ExpectedCellValue(sheetName, 41, 14, "Total Sum of Net Change (Prior Year)"),
					new ExpectedCellValue(sheetName, 42, 14, null),
					new ExpectedCellValue(sheetName, 43, 14, 0),
					new ExpectedCellValue(sheetName, 44, 14, 1d),
					new ExpectedCellValue(sheetName, 45, 14, 3.8615),
					new ExpectedCellValue(sheetName, 46, 14, -2.8615),
					new ExpectedCellValue(sheetName, 47, 14, 1d),
					new ExpectedCellValue(sheetName, 48, 14, 0),
					new ExpectedCellValue(sheetName, 49, 14, 2.2706),
					new ExpectedCellValue(sheetName, 50, 14, -0.1298),
					new ExpectedCellValue(sheetName, 51, 14, -1.1408),
