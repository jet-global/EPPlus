...
{
	[TestClass]
	public class DataFieldFunctionCountTypeTest : DataFieldFunctionTypeTestBase
	{
		#region SingleDataField Override Methods
		public override void ConfigurePivotTableDataFieldFunction()
		{
			base.PivotTable.DataFields.First().Function = DataFieldFunctions.Count;
			base.PivotTable.DataFields.First().Name = "Count of Total";
		}
		...
		public override void ValidatePivotTableRefreshDataField(FileInfo file, string sheetName)
		{
			TestHelperUtility.ValidateWorksheet(file, sheetName, new[]
			{
				...
				new ExpectedCellValue(sheetName, 14, 2, 3d),
				new ExpectedCellValue(sheetName, 16, 2, 1d),
				new ExpectedCellValue(sheetName, 17, 2, 4d),
				...
				new ExpectedCellValue(sheetName, 17, 4, 1d),
				...
				new ExpectedCellValue(sheetName, 14, 6, 3d),
				new ExpectedCellValue(sheetName, 15, 6, 2d),
				new ExpectedCellValue(sheetName, 16, 6, 2d),
				new ExpectedCellValue(sheetName, 17, 6, 7d)
			});
		}
		#endregion
		...
		public override void ValidatePivotTableRefreshMultipleColumnDataFields(FileInfo file, string sheetName)
		{
			TestHelperUtility.ValidateWorksheet(file, sheetName, new[]
			{
				...
				new ExpectedCellValue(sheetName, 29, 2, 1d),
				new ExpectedCellValue(sheetName, 31, 2, 1d),
				new ExpectedCellValue(sheetName, 32, 2, 2d),

				new ExpectedCellValue(sheetName, 23, 3, "Count of Units Sold"),
				...
				new ExpectedCellValue(sheetName, 28, 4, 1d),
				new ExpectedCellValue(sheetName, 29, 4, 1d),
				new ExpectedCellValue(sheetName, 30, 4, 1d),
				new ExpectedCellValue(sheetName, 32, 4, 3d),

				new ExpectedCellValue(sheetName, 23, 5, "Count of Units Sold"),
				new ExpectedCellValue(sheetName, 24, 5, 1d),
				new ExpectedCellValue(sheetName, 25, 5, 1d),
				new ExpectedCellValue(sheetName, 26, 5, 1d),
				new ExpectedCellValue(sheetName, 28, 5, 1d),
				new ExpectedCellValue(sheetName, 29, 5, 1d),
				new ExpectedCellValue(sheetName, 30, 5, 1d),
				...
				new ExpectedCellValue(sheetName, 23, 7, "Count of Units Sold"),
				...
				new ExpectedCellValue(sheetName, 22, 9, "Total Count of Units Sold"),
				new ExpectedCellValue(sheetName, 24, 9, 3d),
				new ExpectedCellValue(sheetName, 25, 9, 3d),
				new ExpectedCellValue(sheetName, 26, 9, 2d),
				new ExpectedCellValue(sheetName, 27, 9, 1d),
				new ExpectedCellValue(sheetName, 28, 9, 1d),
				new ExpectedCellValue(sheetName, 29, 9, 2d),
				new ExpectedCellValue(sheetName, 30, 9, 1d),
				new ExpectedCellValue(sheetName, 31, 9, 1d),
				new ExpectedCellValue(sheetName, 32, 9, 7d)
			});
		}
		#endregion
		...
		public override void ValidatePivotTableRefreshMultipleRowDataFields(FileInfo file, string sheetName)
		{
			TestHelperUtility.ValidateWorksheet(file, sheetName, new[]
			{
				...
				new ExpectedCellValue(sheetName, 44, 6, 1d),
