...
{
	[TestClass]
	public class DataFieldFunctionVarTypeTest : DataFieldFunctionTypeTestBase
	{
		#region SingleDataField Override Methods
		public override void ConfigurePivotTableDataFieldFunction()
		{
			base.PivotTable.DataFields.First().Function = DataFieldFunctions.Var;
			base.PivotTable.DataFields.First().Name = "Var of Total";
		}
		...
		{
			base.PivotTable.DataFields[0].Function = DataFieldFunctions.Var;
			base.PivotTable.DataFields[0].Name = "Var of Total";
		}
		...
		public override void ValidatePivotTableRefreshMultipleColumnDataFields(FileInfo file, string sheetName)
		{
			TestHelperUtility.ValidateWorksheet(file, sheetName, new[]
			{
				...
				new ExpectedCellValue(sheetName, 26, 2, "#DIV/0!"),
				new ExpectedCellValue(sheetName, 32, 2, 50165.28),
				...
				new ExpectedCellValue(sheetName, 32, 4, 325229.19),
				...
				new ExpectedCellValue(sheetName, 32, 6, 43802.08),
		...
		public override void ValidatePivotTableRefreshMultipleRowDataFields(FileInfo file, string sheetName)
		{
			TestHelperUtility.ValidateWorksheet(file, sheetName, new[]
			{
				...
				new ExpectedCellValue(sheetName, 48, 4, 50165.28),
				...
				new ExpectedCellValue(sheetName, 48, 7, 325229.19),
				...
				new ExpectedCellValue(sheetName, 48, 10, 43802.08),
