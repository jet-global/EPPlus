...
{
	[TestClass]
	public class DataFieldFunctionMinTypeTest : DataFieldFunctionTypeTestBase
	{
		#region SingleDataField Override Methods
		public override void ConfigurePivotTableDataFieldFunction()
		{
			base.PivotTable.DataFields.First().Function = DataFieldFunctions.Min;
			base.PivotTable.DataFields.First().Name = "Min of Total";
		}
		...
		public override void ConfigurePivotTableMultipleRowDataFieldsFunction()
		{
			...
			base.PivotTable.DataFields[1].Function = DataFieldFunctions.Min;
			base.PivotTable.DataFields[1].Name = "Min of Units Sold";
		}
		...
		public override void ValidatePivotTableRefreshMultipleRowDataFields(FileInfo file, string sheetName)
		{
			TestHelperUtility.ValidateWorksheet(file, sheetName, new[]
			{
				...
				new ExpectedCellValue(sheetName, 49, 7, 1d),
				...
				new ExpectedCellValue(sheetName, 41, 11, 1d),
				...
				new ExpectedCellValue(sheetName, 47, 11, 1d),
				new ExpectedCellValue(sheetName, 48, 11, 1194d),
				new ExpectedCellValue(sheetName, 49, 11, 1d)
			});
		}
		#endregion
	}
