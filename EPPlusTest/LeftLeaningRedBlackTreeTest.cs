...
/// <summary>
/// This class originally implemented by David Anson (http://dlaa.me/blog/post/9686081) and released under the MIT license.
/// Rereleased here under LGPL.
/// </summary>
namespace EPPlusTest
{
	...
	public class LeftLeaningRedBlackTreeTest
	{
		...
		#region LeftLeaningRedBlackTree Tests
		/// <summary>
		...
		[SuppressMessage("Microsoft.Usage", "CA1806:DoNotIgnoreMethodResults", MessageId = "LeftLeaningRedBlackTree`2<System.Int32,System.Int32>",
		...
		/// <summary>
		/// Verifies that calling GetValueForKey returns a default value when the key is not present.
		/// This is different from the original DA implementation of the LLRB tree.
		/// </summary>
		[TestMethod]
		[Description("Verifies that calling GetValueForKey returns a default value when the key is not present.")]
		[SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", Justification = "TestMethods can not be static.")]
		public void GetValueForMissingKey()
		{
			...
			Assert.AreEqual(0, binaryTree.GetValueForKey(-1));
		}
		...
		[TestMethod]
		public void AddAnExistingNodeWithoutRebalancingUpdatesExistingNode()
		{
			var tree = new LeftLeaningRedBlackTree<int, int>(IntComparison);
			tree.Add(2, 27);
			tree.Add(2, 14, false);
			Assert.AreEqual(14, tree.GetValueForKey(2));
		}

		[TestMethod]
		[ExpectedException(typeof(InvalidOperationException))]
		[SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", Justification = "TestMethods can not be static.")]
		public void AddANewNodeWithoutRebalancingThrowsException()
		{
			var tree = new LeftLeaningRedBlackTree<int, int>(IntComparison);
			tree.Add(2, 27, false);
		}
