...
namespace EPPlusTest
{
	...
	public class WorkSheetTest : TestBase
	{
		...
		[TestMethod]
		public void CopyToEmptySpaceDoesNotClearDestinationRange()
		{
			using (var package = new ExcelPackage())
			{
				var sheet1 = package.Workbook.Worksheets.Add("Sheet1");
				sheet1.Cells[3, 3].Value = "Hello, World!";
				sheet1.Cells[5, 3].Value = "This gets clobbered!";
				sheet1.Cells[5, 5].Value = "This does not get deleted!";
				sheet1.Cells["3:3"].CopyToEmptySpace(sheet1.Cells["5:5"]);
				Assert.AreEqual("Hello, World!", sheet1.Cells[5, 3].Value);
				Assert.AreEqual("This does not get deleted!", sheet1.Cells[5, 5].Value);
			}
		}
